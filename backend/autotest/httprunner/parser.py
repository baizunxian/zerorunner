...
from autotest.httprunner import loader, utils, exceptions
from autotest.httprunner.models import VariablesMapping, FunctionsMapping
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from autotest.httprunner.ext import uploader

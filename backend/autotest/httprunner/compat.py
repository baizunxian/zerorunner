...
from autotest.httprunner.loader import load_project_meta, convert_relative_project_root_dir
...
def _ensure_step_attachment(step: Dict) -> Dict:
    ...
    # 增加case_id
    if "case_id" in step:
        test_dict["case_id"] = step["case_id"]
    else:
        test_dict["case_id"] = ''
    ...
    if "parameters" in step:
        test_dict["parameters"] = step["parameters"]

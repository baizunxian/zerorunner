...
# Cache
TEST_USER_INFO = 'test:user_token:{0}'  # 用户token缓存
TEST_EXECUTE_SET = 'test_execute_set:case:{}'  # 用例执行集合
TEST_EXECUTE_STATIS = 'test_execute_set:statis:{}'  # 用例执行统计
TEST_EXECUTE_PARAMETER = 'test_execute_set:extract_parameter:{}'  # 变量
DATA_STRUCTURE_CASE_UPDATE = 'data_structure:user:{}'  # 数据构造用户变更的接口信息
TEST_USER_LOGIN_TIME = 'test:user_login_time:{}'  # 数据构造用户变更的接口信息

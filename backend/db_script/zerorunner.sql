/*
 ...
 Source Server         : xiaobaicodes.com
 Source Server Type    : MySQL
 Source Server Version : 50743
 Source Host           : xiaobaicodes.com:3306
...
CREATE TABLE `api_info`  (
  ...
  `project_id` bigint(11) NULL DEFAULT NULL COMMENT '所属项目',
  `module_id` bigint(11) NULL DEFAULT NULL COMMENT '所属模块',
...
CREATE TABLE `celery_periodic_task`  (
  ...
  `ui_env_id` int(11) NULL DEFAULT NULL,
  ...
  `case_env_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `celery_periodic_task_changed` VALUES (1, '2023-09-13 14:08:59', NULL, NULL, '2023-09-13 14:08:58', NULL, NULL, NULL);
...
CREATE TABLE `menu`  (
  ...
  `isLink` int(11) NULL DEFAULT 0 COMMENT '开启外链条件，`1、isLink: true 2、链接地址不为空（meta.isLink） 3、isIframe: false`',
  `isHide` int(11) NULL DEFAULT 0 COMMENT '菜单是否隐藏（菜单不显示在界面，但可以进行跳转）',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `isKeepAlive` int(11) NULL DEFAULT NULL COMMENT '菜单是否缓存',
  `isAffix` int(11) NULL DEFAULT NULL COMMENT '固定标签',
  `isIframe` int(11) NULL DEFAULT NULL COMMENT '是否内嵌',
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, 0, '/home', 'home', 'home/index.vue', '首页', 0, 0, 'ele-HomeFilled', 1, 1, 0, 'admin', 0, NULL, 10, NULL, NULL, '2023-09-07 17:39:26', 1, 0, 7, 7, NULL, 'd70ffacccea04e82814380eea0dcd73e');
...
INSERT INTO `menu` VALUES (32, 0, '/api', 'api', 'layout/routerView/parent', 'API测试', 0, 0, 'ele-Apple', 1, 0, 0, '', 2, NULL, 10, '/api/project', '2022-03-14 17:02:22', '2023-07-28 17:54:03', 1, 0, 7, 7, NULL, 'bd771482324c4187b0cddecfce4ad5d2');
...
INSERT INTO `menu` VALUES (38, 37, '/api/apiInfo/edit', 'EditApiInfo', 'api/apiInfo/components/EditApi', '接口编辑', 0, 1, '', 1, 0, 0, '', 0, NULL, 10, '', '2022-03-30 15:53:20', '2023-07-28 18:21:33', 1, 0, 7, 7, NULL, 'c02977afd0c544c1870adbe43e964a6d');
...
INSERT INTO `menu` VALUES (50, 49, '/api/apiCase/edit', 'EditApiCase', 'api/apiCase/EditApiCase', '编辑用例', 0, 1, '', 1, 0, 0, '', 0, NULL, 10, '', '2022-04-12 11:42:09', '2023-07-28 17:54:09', 1, 0, 7, 7, NULL, '271ab5852e804b7b8e80e2e6d4295edf');
...
INSERT INTO `menu` VALUES (57, 0, '/ui', 'ui', 'layout/routerView/parent', 'UI测试', 1, 0, 'ele-Cherry', 1, 0, 0, 'admin', 3, NULL, 10, '', '2022-08-23 11:05:09', '2023-08-02 16:24:55', 1, 0, 7, 7, NULL, '18b3f07689ac45d6aadf77eae75da04c');
...
INSERT INTO `menu` VALUES (59, 53, '/tools/testcase', 'apiTest', 'api/apiTest/index.vue', '接口测试', 0, 1, '', 0, 0, 0, '', 0, NULL, 10, '', '2022-09-13 16:00:00', '2023-07-31 10:31:56', 1, 0, 7, 7, NULL, '730571c1b89d46d492c1f07b83a0b726');
...
INSERT INTO `menu` VALUES (62, 53, '/websocket', '连接1', 'tools/websocket/index.vue', '连接1', 0, 1, '', 1, 0, 0, '0', 0, NULL, 10, '', '2023-02-09 12:27:42', '2023-07-31 10:31:39', 1, 0, 7, 7, NULL, 'e514be038d7c4f779854292fc9a4bc31');
INSERT INTO `menu` VALUES (63, 0, '/projectOrModule', '/projectOrModule', 'layout/routerView/parent', '项目/模块', 0, 0, 'ele-Files', 1, 0, 1, '0', 1, NULL, 10, '', '2023-02-23 11:07:56', '2023-09-07 17:39:31', 1, 0, NULL, 7, NULL, 'db11f1de1ebb4846abe06d21cb7bfd4f');
...
INSERT INTO `menu` VALUES (72, 35, '/ss', 'ss', '', 'ss', 0, 1, '', 1, 0, 0, '0', 0, NULL, 10, '', '2023-08-09 20:28:15', '2023-08-18 12:54:34', 1, 0, 7, 7, NULL, '63646cdf20764ba3a25d14b9d820f64c');
INSERT INTO `menu` VALUES (73, 0, '/precisionTest', 'precisionTest', 'layout/routerView/parent', '精准测试', 0, 0, 'ele-Grape', 1, 0, 0, '0', 6, NULL, 10, '', '2023-08-17 20:17:19', '2023-09-07 15:38:45', 1, 0, 7, 7, NULL, 'd7a0498eb7f24f09a7997342085bd58b');
INSERT INTO `menu` VALUES (74, 75, '/precisionTest/CoverageDetail', 'CoverageDetail', 'precisionTest/CoverageDetail/index.vue', '覆盖率详情', 0, 1, '', 1, 0, 0, '0', 0, NULL, 10, '', '2023-08-17 20:19:57', '2023-09-04 11:24:23', 1, 0, 7, 7, NULL, 'dce6733021e44039b898a9beec974104');
INSERT INTO `menu` VALUES (75, 73, '/precisionTest/CoverageList', 'CoverageList', 'precisionTest/CoverageList/index.vue', '覆盖率报告', 0, 0, '', 1, 0, 0, '0', 0, NULL, 10, '', '2023-08-31 11:12:08', '2023-09-04 11:24:13', 1, 0, 7, 7, NULL, 'c5310d68bc6a4a8eb5c77f56a13b269b');
INSERT INTO `menu` VALUES (76, 73, '/precisionTest/RepositoryManager', 'RepositoryManager', 'precisionTest/RepositoryManager/index.vue', '仓库管理', 0, 0, '', 1, 0, 0, '0', 0, NULL, 10, '', '2023-09-04 11:24:55', '2023-09-04 11:25:26', 1, 0, 7, 7, NULL, 'dc4a6250d18647fe8ebf503ec79678a4');
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES (1, '管理员', '管理员', 10, '1,33,34,38,50,48,42,41,72,58,68,67,65,70,36,62,59,54,76,74,61,29,31,30,51', '2021-04-12 16:56:20', '2023-09-04 11:25:36', 1, 7, 7, 10, 'a70de2584efe40a08f44584f716f9f56');
INSERT INTO `roles` VALUES (3, '测试工程师', '测试工程师', 10, '1,33,34,38,50,48,42,41,72,58,68,67,65,70,36,62,59,54,61,29,31,30,51', '2021-05-21 17:24:53', '2023-08-17 20:07:00', 1, 7, 7, 10, '203441f5d480473cb2de505786edd339');
...
INSERT INTO `user` VALUES (NULL, '2023-08-31 15:24:43', 1, 9, 'xiaobai01', '123456', NULL, '[1]', 'xiaobai01', 0, NULL, 7, 20, NULL, NULL, '[9, 1]', 'db80527db6aa4f7b91802c216e82f558');

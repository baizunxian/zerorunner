    ...
    <el-card>
      ...
      <div class="h100">
        ...
        <el-card id="Response" ref="ResponseRef" v-show="state.reportData">
          ...
          <div style="height: 500px; overflow-y: auto" v-show="state.showReport">
            <z-api-report v-if="state.showReport" :reportData="state.reportData" ref="apiReportRef"></z-api-report>
          </div>
        </el-card>
      </div>
    </el-card>

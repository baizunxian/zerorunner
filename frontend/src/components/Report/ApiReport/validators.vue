<template>
  <el-table :data="validateData.validate_extractor">
...
export interface ValidateExtractorData {
  check: string
  expect_value: string
  check_value: string
  check_result: string
...
export interface PropsData {
  validate_extractor: ValidateExtractorData
}

export default defineComponent({
  name: 'reportValidators',
  props: {
    data: {type: Object as PropType<PropsData>},
  },
  emits: ['update:data'],
  setup(props: any) {

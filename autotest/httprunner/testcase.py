...
class RunRequest(object):
    ...
    # 步骤新增用例id
    def with_step_case_id(self, case_id: Union[Text, int]) -> "RunRequest":
        self.__step_context.case_id = case_id
        return self

    # 用例parameters设置
    def with_parameters(self, **parameters) -> "RunRequest":
        self.__step_context.parameters.update(parameters)
        return self
...
class Step(object):
    ...
    def with_step_message(self, message: Union[Text]) -> TStep:
        """异常信息记录"""
        self.__step_context.message = message
        return self.__step_context

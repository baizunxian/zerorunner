...
class TestReportSaveSchema(BaseModel):
    ...
    run_count: int = Field(None, description="")
    actual_run_count: int = Field(None, description="")
    run_success_count: int = Field(None, description="")
    run_fail_count: int = Field(None, description="")
    run_skip_count: int = Field(None, description="")
    run_err_count: int = Field(None, description="")
    run_log: str = Field(None, description="")
    project_id: int = Field(None, description="")
    module_id: int = Field(None, description="")

...
<!--      <el-divider style="margin: 10px 0 5px 0;"/>-->
        ...
        <el-row>
          ...
          <el-col :span="6">
            <div>
              ...
              <el-input v-model="data.count_number"
      ...
      <div v-else-if="data.loop_type === 'for'" class="controller-content">
        ...
        <el-row>
          <el-col :span="6">
            <el-input v-model="data.for_variable_name"
                      @pointerdown.stop.native
                      @click.stop.native
                      placeholder="定义变量名称"
            >
              <template #suffix>
                  <span class="el-input__suffix-inner" @click="copyText('${'+ data.for_variable_name +'}')">
          ...
          <el-col :span="6">
            <el-input v-model="data.for_variable"
                      @pointerdown.stop.native
                      @click.stop.native
          ...
          <el-col :span="6">
            <span>循环间隔</span>
            <el-input v-model="data.for_sleep_time"
                      @pointerdown.stop.native
                      @click.stop.native
                      placeholder="秒"
            ></el-input>
      ...
      <div v-else-if="data.loop_type === 'while'" class="controller-content">
        ...
        <el-row>
          <el-col :span="5">
            <el-input v-model="data.while_variable"
                      @pointerdown.stop.native
                      @click.stop.native
                      class="com-padding"
                      placeholder="变量,例如：${var}"></el-input>
  ...
  data: {
    ...
    default: () => {
      return {
        // data: {
        //   name: '次数循环',
        //   loop_type: 'count',   // count 次数循环， for for循环， while while循环
        //   value: {
        //     count_number: 0,  // 循环次数
        //     count_interval_time: 0,  // 间隔时间
        //   },
        // }

        // data: {
        //   name: 'for循环',
        //   loop_type: 'for',   // number 次数循环， for for循环， while while循环
        //   value: {
        //     for_variable_name: "",  // 变量名
        //     for_variable: "",  // 变量
        //     for_interval_time: 0,  // 间隔时间 秒
        //   },
        // }
        ...
        //   value: {
        //     while_variable: "",  // 变量
        //     while_comparator: "",  // 比对规则
        //     while_value: "",  // 比对值
        //     while_sleep_time: 3,  // 循环间隔时间 秒
        //     while_timeout: 3,  // 超时时间 秒
        //   },
        // }
      }
    }
